-- Igual que supabase/migrations/20260503120000_onboarding_submissions_user_link.sql
-- y que src/app/lib/onboardingUserLinkRepairSql.ts (mantener los tres alineados).
